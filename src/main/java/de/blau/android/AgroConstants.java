...
public class AgroConstants {
    ...
    public static final String[] LIVESTOCK_DATA = {"Коровы", "Яки", "Лошади", "Овцы", "Козы"};
    public static final String[] PASTURE_TYPE = {"Тип растительности", "Лесная", "Тундровая", "Степная", "Пустынная", "Луговая", "Болотная"};
    public static final String[] TECHNOLOGY_DATA = {"Технология возделывания", "Яровая", "Озимая"};
    public static final String[] TYPE_LAND_DATA = {"Вид угодия", "Пашни", "Сенокосы", "Пастбища", "Залежи", "Многолетние насаждения"};
    ...
    public static final Map<String, String[]> UNDER_TYPE_LAND_DATA = Map.of("Пашня", new String[]{"Виды пашен", "Богара", "Условно богара", "Орошаемая", "Условно орошаемая"},
